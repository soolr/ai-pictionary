      ...
      <div className="w-full max-w-3xl flex flex-col gap-6">
        ...
        <div className="flex justify-center">
          <button
            onClick={handleGuess}
            disabled={isLoading}
            className="w-full sm:max-w-xs px-6 sm:px-10 py-3 sm:py-4 bg-[#bb86fc] text-black font-semibold rounded-xl text-base sm:text-lg shadow-lg shadow-purple-500/20 hover:bg-[#9965f4] hover:shadow-purple-500/40 hover:-translate-y-1 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            {isLoading ? (
